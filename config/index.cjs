  ...
  USERS: [
    {
      ...
      id: 'odR1z6ggtUzn1REE490abuRClCp4',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: 'pD-ncdpJ0DVYDbo0aj1ty_TkbgWFVVVbPgSjtY9n91g',
      // 所在省份
      province: '江西',
      // 所在城市
      city: '九江',
      ...
      festivals: [
        ...
        {
          type: '*生日', name: '老婆', year: '2000', date: '12-12',
        },
        {
          type: '节日', name: '恋爱纪念日', year: '2021', date: '06-15',
        },
...
//         { keyword: 'ex_day', date: '2022-09-10' }
  ...
  CALLBACK_TEMPLATE_ID: 'uJqOYFAMGpjEK9cHP4jp00FSy572AFqe6Mz5A4Xson0',
  ...
  CALLBACK_USERS: [
    {
      ...
      id: 'odR1z6qE1SD89SIzGCw85vY32nG0',
    }
    // 你可以不断按格式往下增加
    // ...
  ],
